...
{
    /**
     * Route("/api", name="api_auteurs", methods={"GET"})
     */
     ...
     */
    public function create(Request $request, ObjectManager $manager, NationaliteRepository $repoNation, SerializerInterface $serializer, ValidatorInterface $validator)
    {
